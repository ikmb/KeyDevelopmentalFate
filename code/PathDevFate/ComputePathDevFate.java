...
public static ArrayList<Gene> findConnectors(ArrayList<Gene> component,ArrayList<Gene> ds){
			  ...
			  for(int i = 0;i < set.size();i++) {
				  ...
				  //System.out.println(set.get(i).get(0)+"\t"+set_gene.get(i).get_black_degree());
			  }
			  sorter.sort_black_degree(set_gene);
			  //for(Gene g:set_gene) {
				 // System.out.println(set_gene);
				  //System.out.println(g.get_name()+"\t"+g.get_black_degree());
			  //}
			  //System.out.println(set_gene);
...
public static ArrayList<Gene> mimicDS(ArrayList<Gene> component,ArrayList<Gene> connectedSet){
			...
			//System.out.println(temp_connect);
			...
			while(i < counter){
				...
				//System.out.println("mimicDS_CC is:" + i+"\t"+g.get_name()+"\t"+flag);
				i++;
			}	
			Network.set_all_blue(component);
