...
public class PathDevFate{
	...
	public static void writeOutput(PathFateDevResult mcds_result, String path) {
	 ...
	 * @return
	 */
	public static PathFateDevResult mcds(String input, ArrayList<String> arr){
			...
			if(input.equals("LCCD")){
				...
				//mcds = ComputePathDevFate.findConnectors(largest_ConnectedComponent,ds);
				ArrayList<Gene> black_darkGray = ComputePathDevFate.findConnectors(largest_ConnectedComponent,ds);
				
				mcds = ComputePathDevFate.mimicDS(largest_ConnectedComponent,black_darkGray);
				...
				return new PathFateDevResult(mastergene_colors, nw);
	...
	public static void main(String[] args) {
		...
		// compute mcds
		PathFateDevResult mcds_result = mcds(parameters[0], arr);
